...
import com.busvoyage.busvoyage.repository.BusScheduleRepository;
import com.busvoyage.busvoyage.repository.CustomerRepository;
import com.busvoyage.busvoyage.repository.ReservationRepository;
...
public class ReservationServiceImpl implements ReservationService {
    ...
    public Reservation addReservation(Reservation reservation) {
        ...
        final boolean doesCustomerExist =
                customerRepository.existsByMobileOrEmail(reservation.getCustomer().getMobile(), reservation.getCustomer().getEmail());
        if (doesCustomerExist) {
            customer =
                    customerRepository.findByMobileOrEmail(reservation.getCustomer().getMobile(), reservation.getCustomer().getEmail()).orElseThrow();
        } else {
